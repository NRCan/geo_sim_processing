...
def build_and_launch(title, qgs_geoms, rectangularity_tol, compactness_tol, pattern_ratio, output_pattern):
    ...
    bp_results = BuildingPattern.match(qgs_features, rectangularity_tol, compactness_tol, pattern_ratio,
...
class Test(unittest.TestCase):
    ...
    def test_case02(self):
        ...
        qgs_feature_out = build_and_launch(title,[qgs_geom0], .85, .9, .75, False)
        out_qgs_geom0 = create_polygon([(0,10), (10,10), (10,0), (0,0), (0,10)], [])
